  ...
  return page.$eval(
    ...
    forms =>
      forms.map(form => {
        ...
        const quote =
          /request.?a?.?quote|get.?a?.?quote|quote/i.test(
            text
          );

        const booking =
          /book|booking|appointment|schedule/i.test(
            text
          );
  ...
  inspection.routeHealth =
        ...
        .filter(
          route =>
            ...
            (
              ...
              route.routeHealthEntry.status === "working" ||
              route.routeHealthEntry.status === "redirected"
            )
        )
        .sort(
          (a, b) =>
    ...
    for (
      ...
      try {
        ...
        /*
         * A failed important-page browser render must not
