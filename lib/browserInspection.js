  ...
  await puppeteer.launch({
    ...
    await page.$$eval(
      ...
      elements => {
        ...
        const routeNamePattern =
          /^(?:contact|contact-us|services?|about|about-us|quote|get-a-quote|booking|book(?:ing)?|appointment|location|directions|pricing|prices|team|faq)$/i;
        ...
        const extractDestination =
          element => {
            ...
            if (directHref) {
              return {
                value: directHref.trim(),
                source: element.hasAttribute("href")
                  ? "href"
                  : "data-attribute"
              };
            }
