  ...
  inspection.routeHealth =
    ...
    for (
      ...
      try {
        ...
        /*
         * Allow client-side navigation time to render the
         * destination before collecting its form evidence.
         * Do not submit or interact with form controls.
         */
        await new Promise(
          resolve =>
            setTimeout(
        ...
        let routeForms =
          await collectRenderedForms(
            page
          );

        /*
         * Some SPA routes render their controls shortly after
         * the route transition. Give the DOM one bounded retry
         * before declaring that no form was found.
         */
        if (
          routeForms.length === 0
        ) {
        ...
        /*
         * A failed important-page browser inspection must not
         * invalidate the successful homepage inspection.
         * The server route-health result remains authoritative
         * for the direct URL request.
         */
        try {
          await page.goto(
            url,
