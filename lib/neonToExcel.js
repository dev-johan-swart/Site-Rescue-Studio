...
async function syncNeonToExcel() {
  ...
  /*
 * Create a safety backup for manual runs.
 *
 * Scheduled runs intentionally skip backups so that
 * Windows Task Scheduler does not create a new
 * backup file every few minutes.
 */
...
if (!isScheduledRun) {
  ...
  console.log(
    "\nScheduled run detected — safety backup skipped."
  );
}
